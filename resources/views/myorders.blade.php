...
@section('content')
    ...
    <nav>
        <div class="container">
            <!-- Header Logo -->
            <div class="logo"><a title="Datson" href="{{url('/')}}"><img alt="Datson" src="images/logo.png"></a></div>
            <!-- End Header Logo -->
                        ...
                        <form method="post" action="#">
                            <fieldset>
                                <table class="data-table cart-table" id="shopping-cart-table">
                                    <thead>
                                    <tr class="first last">
                                        <th rowspan="1"><span class="nobr">Order date</span></th>
                                        <th colspan="1" class="a-center"><span class="nobr">Total Price</span></th>
                                    ...
                                    <tr class="first last">
                                        <td class="a-right last" colspan="50">
                                            <button id="empty_cart_button" class="button" title="Clear Cart" value="empty_cart" name="update_cart_action" type="submit"><span>Delete order history</span></button>
                                        </td>
                                    </tr>
                                    </tfoot>
                                    <tbody>
                                    @foreach($orders as $o)
                                        <tr class="first odd">
                                            <td><h2 class="product-name"> <a href="#">{{$o->date}}</a> </h2></td>
                                            <td class="a-center hidden-table"><span class="cart-price"> <span class="price">${{$o->total}}</span> </span></td>
                                            <td class="a-center last"><a title="View order details" href="{{url('/orderDetails/'.$o->id)}}"> View</a> <a class="button remove-item" title="Remove item" href="delete product"><span><span>Remove item</span></span></a> </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
