                ...
                <div class="cart">
                    ...
                    <div class="table-responsive">
                                ...
                                <table class="data-table cart-table" id="shopping-cart-table">
                                    ...
                                    <tfoot>
                                    <tr class="first last">
                                        <td class="a-right last" colspan="50"><a href="{{url('/products')}}"><button  class="button btn-continue" title="Continue Shopping" type="button"style="color:red">Continue Shopping</button></a>
                                     <button id="empty_cart_button" class="button" title="Clear Cart" value="empty_cart" name="update_cart_action" ><a href="{{url('/delete_cart')}}"><span class="done">Clear Cart</span></a></button></td>
                                    </tr>
                                    </tfoot>
                                    <tbody>
                                    ...
                                    @php
                                    if(isset($c->photo[0]))
                                    $src=asset('img/'.$c->photo[0]->url);
                                    else $src=asset('img/good.png');
                                    @endphp
                                    <tr class="first odd">
                                        <td class="image"><a class="product-image" title="" href="#"><img width="75" height="75" alt="Women's Crepe Printed Black" src="{{$src}}"></a></td>
                                        ...
                                        <td class="a-center hidden-table wishlist" id={{$c->product->id}}>Move</td>
                                        <td class="a-center hidden-table"><span class="cart-price"> <span class="price">${{$c->product->price}}</span> </span></td>
                                        <td class="a-center movewishlist"><input maxlength="12" class="input-text quantity" title="Qty" size="4" value="{{$c->count}}" id={{$c->id}}></td>
                                        <td class="a-center movewishlist"><span class="cart-price"> <span class="price">${{$c->product->price*$c->count}}</span> </span></td>
                                        <td class="a-center last"><a class="button remove-item" title="Remove item" href="{{url('/deleteCartProduct/'.$c->id)}}"><span><span>Remove item</span></span></a></td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                </table>
