...
{{--@foreach ($user2 as $value)--}}
    {{-- @if ($value["age"]>20)
    <div style="background-color: yellow">{{$value["user2"].", age ".$value["age"]}}</div>
    @else
    <div style="background-color: green">{{$value["user2"].", age ".$value["age"]}}</div>
    @endif --}}

{{--<div style="background-color: {{$value["age"]>19?'yellow':'green'}}">{{$value["user2"].", age ".$value["age"]}}</div>--}}
{{--@endforeach--}}
...
<nav>
    <div class="container">
        ...
        <ul class="nav hidden-xs menu-item menu-item-left">
            <li class="level0 parent drop-menu active"><a href="{{url('/')}}"><span>Home</span></a>
        ...
        <ul class="nav hidden-xs menu-item menu-item-right">
            ...
            <li class="mega-menu"><a class="level-top" href="g{{url('/product')}}"><span>Furniture</span></a>
    ...
    <div class="container">
        <div id="rev_slider_4_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="classicslider1" style="margin:0px auto;background-color:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
            ...
            <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                <ul>
                    <!-- SLIDE  -->
                    <li data-index="rs-16" data-transition="zoomout" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="{{asset('images/slide-img1.jpg')}}"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{asset('images/slide-img1.jpg')}}" alt="">
                        <!-- LAYERS -->
