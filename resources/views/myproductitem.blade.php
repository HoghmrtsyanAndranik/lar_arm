                            ...
                            <form action="#" method="post" id="product_addtocart_form">
                                ...
                                <div class="product-img-box col-sm-4 col-xs-12">
                                    ...
                                    <div class="product-image">
                                        <div class="large-image"> <a href="{{asset('img/'.$product->photo[0]->url)}}" class="cloud-zoom" id="zoom1"> <img src="{{asset('img/'.$product->photo[0]->url)}}" alt="product image"> </a> </div>
...
{{--                                    </div>--}}
                                    ...
                                    <div class="add-to-box">
                                        <div class="add-to-cart">
                                            ...
                                            <button onClick="productAddToCartForm.submit(this)" class="button btn-cart" title="Edit" type="button"><a href="{{url('/myproduct/edit/item/'.$product->id)}}" style="color: white">Edit</a></button>
                                        </div>
